...
- architecture
- system-design
summary: A detailed system architecture for a personal knowledge brain that captures
  anything, self-organizes with AI, visualizes as a graph, and answers questions via
  RAG.
