...
- model
- embedding
summary: A pre-trained sentence embedding model for tasks like clustering or semantic
  search.
...
. We benefited from efficient hardware infrastructure to run the project: 7 TPUs v3-8, as well as intervention from Googles Flax, JAX, and Cloud team member about efficient deep learning frameworks.
Intended uses
...
277,230
Stack Exchange
Duplicate questions (bodies)
250,519
Stack Exchange
Duplicate questions (titles+bodies)
250,460
...
User notes:
Local embedding model for note similarity and RAG retrieval
